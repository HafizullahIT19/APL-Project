...
const languages = {
    fa:{
        ...
        // Footer
        footer:{
            copyright:"&copy; کپی رایت. تمام حقوق این سایت متعلق به مجموعه ی تاپ لرن میباشد",
        },
    },
    en:{
        title: "Restaurant",
        ...
        aboutUs:{
            ...
            description: "Lorem ipsum dolor sit amet consectetur adipisicing elit. Laborum rerum quo nulla laboriosam voluptatibus vel, accusantium similique, id unde repudiandae labore ad rem alias vero temporibus libero sequi itaque ut!",
            moreInf: "More...",
        },
        // Gallery
        gallery:{
